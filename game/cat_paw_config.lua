...
--============================ Layer: Core ==============================
	core = {
		...
		env = {
			...
			--Those defaults are mainly used since Love2D does not allow reading 
...
--============================ Layer: Engine ==============================
	engine = {
		...
		game = {
			...
			targetWindowW = 640 * 3,                     --Default: 800
			targetWindowH = 360 * 3,                     --Default: 600
			--Used for the window title, save directory identity, etc....
			name = "Serious",                        --Default: "CatPaw's Purrfect Game"
			...
			globalsFile = "GLOBALS",                 --Default: ""
			--The entry point of your project.
			entryPoint = "core.Game",                --Default: "Game"
		},
	},
}
